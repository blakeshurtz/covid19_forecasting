...
COVID-19-geographic-disbtribution-worldwide-", today(), ".xlsx")
...
usa_reg[nrow(usa_reg), ]$y = 75364
china_reg[nrow(china_reg), ]$y = 4643
france_reg[nrow(france_reg), ]$y = 26268
italy_reg[nrow(italy_reg), ]$y = 30395
japan_reg[nrow(japan_reg), ]$y = 613
sk_reg[nrow(sk_reg), ]$y = 256
brazil_reg[nrow(brazil_reg), ]$y = 9897
india_reg[nrow(india_reg), ]$y = 2109
